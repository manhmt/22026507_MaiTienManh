#include "game_map.h"
GameMap::GameMap() : game_map_{} // Add the constructor definition and initialize game_map_
{
}
GameMap::~GameMap()
{
...
void GameMap::DrawMap(SDL_Renderer* screen)
{
	...
	//x1 = ((game_map_.start_x_ + TILE_SIZE)% TILE_SIZE) * -1;
	x1 = ((game_map_.start_x_ % TILE_SIZE) + TILE_SIZE) % TILE_SIZE * -1;

	x2 = x1 + SCREEN_WIDTH + (x1 == 0 ? 0 : TILE_SIZE);

	y1 = ((game_map_.start_y_ % TILE_SIZE) + TILE_SIZE) % TILE_SIZE * -1;
